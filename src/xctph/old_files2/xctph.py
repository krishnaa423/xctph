...
class Xctph:
    ...
    def calc(self):
        ...
        # Parallel version.
        self.xctph_parallel_size = ParSize(shape=(self.nxct, self.nxct, self.nQ, self.nmodes, self.nQ), comm=self.comm)
        self.xct_start, self.xct_end = self.xctph_parallel_size.get_local_range()
            ...
            for iq in range(self.nq):
                ...
                for ik in range(self.nk):
                    ...
                    for mnb in range(self.xct_start, self.xct_end):
                        mb, nb = self.xctph_parallel_size.get_idx(mnb)
                        # electron channel
